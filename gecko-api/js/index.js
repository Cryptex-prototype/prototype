            ...
            $.getJSON(url)
                ...
                <tbody id="coinChart"></tbody>
                    ...
                    data.forEach((ex) => {
                        ...
                        catElement +=
                            `<tr>
<td class='exchange-name'><span style="cursor:pointer;" onclick="getPools('https://api.geckoterminal.com/api/v2/networks/eth/dexes/${ex.id}/pools','${ex.name}')"><img src='${ex.image}' alt=''>${ex.name}</span></td>
